...
class DEGraphWin(tk.Canvas):
    ...
    def getMouseAsync(self):
        ...
        '''Edit by Matt Zhu: This function allows the asynchronous getting of mouse clicks, therefore enabling the use of multiple control panels at once'''
...
class Button:
    ...
    def isDrawn(self):
        '''returns True if button is drawn, False otherwise'''
        return self.rect.isDrawn() and self.caption.isDrawn()
